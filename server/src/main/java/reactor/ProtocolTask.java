...
public class ProtocolTask<T> implements Runnable {
	...
	//	TBGPProtocolCallback<String> callback = new TBGPProtocolCallback<String>();
	//	callback.setHandler(_handler);
      while (_tokenizer.hasMessage()) {
         T msg = _tokenizer.nextMessage();   
         this._protocol.processMessage(msg, (ProtocolCallback<T>) _handler.getCBProtocol());
	...
	public void sendMsg(T msg) throws CharacterCodingException{
